...
main = function() {
    ...
    if(!localStorage.FlappyTube_hiScore){
        localStorage.FlappyTube_hiScore = "0";}//decamincow
  ...
  hitBirds = function(tube, bird) {
    ...
    bird.kill();
    score += 1;
//    bestScore = score > bestScore ? score : bestScore; //decamincow
    localStorage.FlappyTube_hiScore = score > localStorage.FlappyTube_hiScore ? score : localStorage.FlappyTube_hiScore;
...
//    bestText.setText(bestScore); //decamincow
    bestText.setText(localStorage.FlappyTube_hiScore);
    bestText.x = 210;
    bestText.y = 240;
    scoreText.x = 210;
    scoreText.y = 195;
